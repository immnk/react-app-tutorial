  ...
  return (
    <div>
      ...
      <ul className="menu">
        ...
        <li><button className="button" onClick={()=> changeLesson(3.1)}>Lesson 3.1</button></li>
        <li><button className="button" onClick={()=> changeLesson(4)}>Lesson 4</button></li>
      </ul>
      ...
      { lessonNumber === 3.1 ? <Lesson31 title="Welcome to GitHub Cards App with functions"/> : null }
      { lessonNumber === 4 ? <Lesson4 title="Cards App"/> : null }
    </div>
  );
}
